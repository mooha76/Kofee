...
func (c *userServiceClient) SaveUser(ctx context.Context, in *SaveUserRequest, opts ...grpc.CallOption) (*SaveUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.UserService/SaveUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) FindUserByPhone(ctx context.Context, in *FindUserByPhoneRequest, opts ...grpc.CallOption) (*FindUserByPhoneResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/pb.UserService/FindUserByPhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UserService_FindUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pb.UserService/FindUserByPhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
